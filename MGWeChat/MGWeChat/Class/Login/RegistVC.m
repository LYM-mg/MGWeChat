...
- (void)setUpMainView {
    ...
    float topPading = IS_IPHONE4 ? 164/2-45 + MGNavHeight : 164/2 + MGNavHeight;
    // 1.背景图片
    ...
    for (int i=0; i<4; i++) {
        UITextField *textFiled=[[UITextField alloc] initWithFrame:(CGRectMake(106/2, topPading+50*i, MGScreenW-106, 30))];
        if(i==0||i==3)
        ...
        if(i == 3)
            textFiled.width = MGScreenW-106-105;
        ...
        if(i ==2 ){
            ...
            receiveBtn.frame=CGRectMake(MGScreenW-106/2-210/2,CGRectGetMaxY(textFiled.frame)-0.5, 210/2, 51);
    ...
    registBtn.frame=CGRectMake(106/2,CGRectGetMaxY(receiveBtn.frame) + 2*MGMargin, MGScreenW-106, 40);
    ...
    protocloBtn.frame=CGRectMake(0, MGScreenH-76/2, MGScreenW, 76/2);
    ...
    UIView *line=[[UIView alloc] initWithFrame:(CGRectMake(MGScreenW/2-36, protocloBtn.frame.origin.y+56/2, 11*12, 0.5f))];
    ...
    if(textField.tag == 104){
        if(IS_IPHONE4||IS_IPHONE5){
            [UIView animateWithDuration:0.2 animations:^{
                self.view.frame=CGRectMake(0, -60, MGScreenW, MGScreenH-64);
...
- (void)textFieldDidEndEditing:(UITextField *)textField{
    if(textField .tag==104){
        if(IS_IPHONE4||IS_IPHONE5){
            [UIView animateWithDuration:0.2 animations:^{
                self.view.frame=CGRectMake(0, 64,  MGScreenW, MGScreenH-64);
            } completion:nil];
        }
    }
