...
- (void)setMainView{
    ...
    // 2.手机号
    _phoneTextField = [[UITextField alloc] initWithFrame:(CGRectMake(106/2, topPading, MGScreenW-106, 30))];
    ...
    // 3.验证码输入框
    _yzmTextFiled=[[UITextField alloc] initWithFrame:(CGRectMake(106/2,_phoneTextField.y+50, (MGScreenW-106-210/2), 30))];
    ...
    receiveBtn.frame=CGRectMake(MGScreenW-106/2-210/2, CGRectGetMaxY(_phoneTextField.frame)-0.5, 210/2, 51);
