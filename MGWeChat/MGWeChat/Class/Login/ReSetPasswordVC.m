...
- (void)setMainView{
    ...
    // 2.密码输入框
    _pwTextFiled = [[UITextField alloc] initWithFrame:(CGRectMake(106/2, topPading, MGScreenW-106, 30))];
    ...
    // 3.确认输入框
    _repwTextFiled=[[UITextField alloc] initWithFrame:(CGRectMake(106/2, CGRectGetMaxY(_pwTextFiled.frame)+20, MGScreenW-106, 30))];
